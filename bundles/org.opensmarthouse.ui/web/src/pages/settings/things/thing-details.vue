...
+             <f7-list-button color="#329E28" title="View Network Map" @click="openZWaveNetworkPopup"></f7-list-button>
      ...
      <<f7-tab id="channels" disabled="!thingType.channels" :tab-active="currentTab === 'channels'">
        <f7-block v-if="currentTab === 'channels'" class="block-narrow">
          ...
          <f7-col v-if="isExtensible || thing.channels.length > 0">
            <f7-list>
              <f7-list-button class="searchbar-ignore" color="#329E28" title="Add Channel" v-if="isExtensible && thing.editable" @click="addChannel()"></f7-list-button>
    ...
    <!-- <f7-fab position="right-bottom" color="#329E28" slot="fixed" @click="codePopupOpened = true">
